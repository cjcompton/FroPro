...
function ReasonsNeeded() {
    return(
        <section  className="bg-BGLightCream border-t-2 border-gray-200 pb-10">
            ...
            <div className="relative z-20">
                <div className="grid gap-4 grid-cols-2 md:grid-cols-4 p-3 text-center">
                    <div className="border-2 border-black rounded-md p-3">
                        ...
                        />
                        <h1 className="mx-auto p-0 m-0 font-bold text-lg text-FroProRed">Large Variety</h1>
                        <p>
                    ...
                    <div className="border-2 border-black rounded-md p-3">
                        <img 
                            ...
                            className="max-h-24 mx-auto"
                        />
                        <h1 className="mx-auto p-0 m-0 font-bold text-lg text-FroProRed">High Protein</h1>
                        <p>
                    ...
                    <div className="border-2 border-black rounded-md p-3">
                        <img 
                            ...
                            className="max-h-24 mx-auto"
                        />
                        <h1 className="mx-auto p-0 m-0 font-bold text-lg text-FroProRed">Affordable Price</h1>
                        <p>
                    ...
                    <div className="border-2 border-black rounded-md p-3">
                        <img 
                            ...
                            className="max-h-24 mx-auto"
                        />
                        <h1 className="mx-auto p-0 m-0 font-bold text-lg text-FroProRed">Highly Rated</h1>
                        <p>
